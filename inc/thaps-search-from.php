...
<div class="thaps-from-wrap">
   <input id='thaps-search-text' name='thaps' placeholder='<?php echo esc_attr('product search');?>' class="thaps-form-control search-autocomplete" value='<?php echo get_search_query(); ?>' type='text' title='<?php echo esc_attr_x( 'Search for:', 'label', 'th-advance-product-search' ); ?>' />
